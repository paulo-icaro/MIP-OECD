...
# --- Funcao Cronometro --- #
source('RAIS/Função - code_time.R', encoding = 'LATIN1')                # FunÃ§Ã£o que contabilizar o tempo do code // Se precisar use setwd para mudar o path raiz
  ...
  for (i in 1:45){                                                                           # i para linha
    for (j in 1:45){                                                                         # j para coluna
      ...
      Plots <- ggplot() + 
        ...
        # Caso deseje plotar para mais de um paÃ­s, basta copiar o trecho abaixo
